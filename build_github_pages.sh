...
if ! odin-linux-amd64-nightly+2025-01-08/odin build main_web -target:freestanding_wasm32 -build-mode:obj -define:RAYLIB_WASM_LIB=env.o -vet -strict-style -o:speed -out:$OUT_DIR/game; then
  exit 1
fi

ODIN_PATH=$(odin-linux-amd64-nightly+2025-01-08/odin root)
